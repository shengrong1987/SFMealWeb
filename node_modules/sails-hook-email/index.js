  ...
  return {
      ...
      if (sails.config[self.configKey].testMode) {
        ...
        try {
          if (sails.config[self.configKey].transporter) {
            ...
            console.log("email:" + sails.config[self.configKey].transporter.auth.user);
    ...
    send: function (template, data, options, cb) {
      ...
      emailTemplate.render(data, function (err, results) {
        ...
        defaultOptions.html = results.html;
        if (results.text) defaultOptions.text = results.text;
        ...
        transport.sendMail(mailOptions, function (err, results) {
          if (err) {
            sails.log.verbose('EMAILING Failed:', err);
            return cb(err);
          }
