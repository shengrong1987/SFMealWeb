...
FBOAuth2.prototype.getLoginDialogURI = function(){
  ...
  var params = {
    ...
    response_type: 'code',
    scope: 'public_profile,email,user_birthday,user_education_history,user_location,user_hometown'
  };
...
FBOAuth2.prototype.getMe = function(cb){
  var params = {
    fields : 'email,name,age_range,gender,picture'
  };
  this.get(this._profileURI + '?' + this.toQuery(params), cb);
};
