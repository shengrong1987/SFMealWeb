...
var notification = {
  ...
  mergeI18N : function(model, action, req, locale, params){
    var i18ns = ['enter-website','open-order','fen','order','order-number','dingdan','user','delivery-fee','total','footer-send-by','our-mailing-address','tax','service-fee','question-email','click-enter-info','click-upload-info','click-apply','comment','about-us','contact-us','privacy','step1','footer-bar-info','tip-amount'];
    if(model === "Order"){
      switch(action){
        case "new":
